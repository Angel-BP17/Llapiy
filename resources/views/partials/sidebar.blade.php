...
<nav class="side-navbar">
    ...
    <div class="sidebar-header d-flex align-items-center">
        ...
        <div class="title">
            ...
            <h1 class="h6">{{ Auth::user()->userType->name }}</h1>
    ...
    <!-- Menús de navegación del sidebar-->
    <span class="heading">FN. COLABORARDOR</span>
    ...
    @if (Auth::user()->isAdminOrManager())
        <span class="heading">FN. REVISOR/APROBADOR</span>
        <ul class="list-unstyled">
    ...
    <!-- Menú de módulos extras -->
    @if (Auth::user()->userType->name == 'Administrador')
        <span class="heading">FN. ADMINISTRADOR</span>
        <ul class="list-unstyled">
            ...
            <!-- Gestión de tipos de docuemntos -->
            <li
            ...
            <!-- Gestión de áreas, grupos y subgrupos -->
            <li
                ...
                <a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i
                        class="icon-interface-windows"></i>Áreas</a>
            ...
            <li class="{{ Request::routeIs('activity.logs') ? 'active' : '' }}"><a
