 ...
 * @route '/sections/{section}/andamios/{andamio}/boxes/{box}'
 */
export const destroy = (args: { section: string | number | { id: string | number }, andamio: string | number | { id: string | number }, box: string | number | { id: string | number } } | [section: string | number | { id: string | number }, andamio: string | number | { id: string | number }, box: string | number | { id: string | number } ], options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
 ...
 * @route '/sections/{section}/andamios/{andamio}/boxes/{box}'
 */
destroy.url = (args: { section: string | number | { id: string | number }, andamio: string | number | { id: string | number }, box: string | number | { id: string | number } } | [section: string | number | { id: string | number }, andamio: string | number | { id: string | number }, box: string | number | { id: string | number } ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
                    section: args[0],
                    andamio: args[1],
 ...
 * @route '/sections/{section}/andamios/{andamio}/boxes/{box}'
 */
destroy.delete = (args: { section: string | number | { id: string | number }, andamio: string | number | { id: string | number }, box: string | number | { id: string | number } } | [section: string | number | { id: string | number }, andamio: string | number | { id: string | number }, box: string | number | { id: string | number } ], options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
    url: destroy.url(args, options),
    method: 'delete',
})
